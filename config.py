...
tg_capture_err = "False"                                        #сообщать о ошибках видеозахвата в телеграм или нет(True или False)
motion_cams   = 1,2,3,4,5                                       #камеры на которых реагируем на срабатывание детектора двиежения (перечисляем через запятую)
##########################################################################
